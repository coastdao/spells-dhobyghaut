...
data = {
    'smart_contract[address_hash]': contract_address,
    'smart_contract[is_yul]': False,
    'smart_contract[name]': contract_name,
    'smart_contract[contract_source_code]': code,
    'smart_contract[compiler_version]': compiler_version,
    'smart_contract[optimization]': True if optimizer_enabled else False,
    'smart_contract[optimization_runs]': optimizer_runs,
    'smart_contract[autodetect_constructor_args]': True,
    'smart_contract[evm_version]': evm_version,
    'smart_contract[nightly_builds]': False
    'licenseType': license_number,
    'external_libraries[library1_name]': library_name,
    'external_libraries[library1_address]': library_address,
}
...
url = 'http://192.168.20.111:5000/evm/verify_smart_contract/contract_verifications'
headers = {
    'User-Agent': ''
}
